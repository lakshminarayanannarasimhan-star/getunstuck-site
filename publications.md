...
<section class="section-wide">
  ...
  <div class="series-grid">
    ...
    <a class="series-card" href="#series-b">
      ...
      <h3 class="series-title">Beyond Execution</h3>
      <p class="series-desc">From execution to indispensability — the arc from delivery to ownership in the technology-services and GenAI era.</p>
      <div class="series-meta">6 articles · Drafting</div>
    </a>
...
<section class="section-wide" id="series-b">
  <div class="series-section-header">
    <div>
      <div class="section-label">Series B · Beyond Execution</div>
      <h2>From execution to indispensability.</h2>
      <p class="prose" style="margin-top:.8rem;">Six articles on the arc that separates leaders who execute from those who become indispensable — in the technology-services and GenAI era. The framework: Execution → Trust → Influence → Indispensability → Ownership → Growth.</p>
    </div>
    <span class="series-status in-progress" style="align-self:flex-start;">
      <span class="series-dot"></span>In progress
    </span>
  ...
  <div class="coming" style="margin-top:1.8rem;">
    ...
    <p>Articles will appear here as they are finalised and published.</p>
  </div>
</section>
