...
title: About
permalink: /about/
description: "Lakshmi Narayanan — leadership systems practitioner, author, and lifelong student. 25 years of building what others theorise about."
---
...
<section class="section-wide">
  <div class="layout-sidebar">
    <div>
      ...
      <h2>My father taught me what teaching really means.</h2>
...
<section class="section-wide">
  <div class="layout-sidebar">
    ...
    <aside>
      <div class="hero-panel">
        <div class="panel-label">Currently open to</div>
        <ul style="list-style:none;display:flex;flex-direction:column;gap:.8rem;margin-top:.5rem;">
          ...
          <li style="font-size:.93rem;color:var(--muted);">✦ &nbsp;Writing collaborations</li>
        </ul>
        <a class="panel-link" href="mailto:hello@getunstuck.in">Get in touch</a>
      </div>
    </aside>
  </div>
</section>
